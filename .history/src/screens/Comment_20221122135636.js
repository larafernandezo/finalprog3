  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TextInput keyboardType='default' placeholder='Escribí tu comentario' onChangeText={(text) => { this.setState({ coent: text }) }} value={this.state.comment} style={styles.input}/>
